...
describe('resolveCellNavigation', () => {
  ...
  it.each([
    ...
    ['left from a filled boundary through blanks', 'E1', { key: 'ArrowLeft', command: true }, 'C1'],
    ['left from blank to content', 'D1', { key: 'ArrowLeft', command: true }, 'C1'],
    ['left with no earlier content reaches edge', 'F4', { key: 'ArrowLeft', command: true }, 'A4'],
    ['up through a filled run', 'C3', { key: 'ArrowUp', command: true }, 'C1'],
    ['up from a filled boundary through blanks', 'C5', { key: 'ArrowUp', command: true }, 'C3'],
    ['up from blank to content', 'C4', { key: 'ArrowUp', command: true }, 'C3'],
    ['up with no earlier content reaches edge', 'F4', { key: 'ArrowUp', command: true }, 'F1'],
    ['down through a filled run', 'C1', { key: 'ArrowDown', command: true }, 'C3'],
    ['down from a boundary through blanks', 'C3', { key: 'ArrowDown', command: true }, 'C5'],
    ['down from blank to content', 'C4', { key: 'ArrowDown', command: true }, 'C5'],

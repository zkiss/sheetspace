...
References should become first-class entities. A user should be able to understand where a formula gets its data from without manually searching through sheets.
